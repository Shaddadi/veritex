...
This section aims to reproduce results in the CAV'22 tool paper, inculding Figure 2&3&4 and Table 2&3. Results are stored in 'veritex/cav22_artifact/results'. 
...
```bash
cd examples/ACASXu/repair
python veritex/methods/reachplot.py --property 'path_to_property1',...'path_to_property1'
