...
if __name__ == "__main__":
    ...
    file_handler = logging.FileHandler('verify_p10.log', 'w+')
    ...
    properties = []
    vnnlib_specs = read_vnnlib_simple('../nets/prop_10.vnnlib', num_inputs=5, num_outputs=5)
    ...
    for n, prop in enumerate(properties):
        ...
        logging.info('')
        logging.info(f'Network {i} {j} on property 10')
    ...
    # with open('verification_p10.pkl', 'wb') as f:
