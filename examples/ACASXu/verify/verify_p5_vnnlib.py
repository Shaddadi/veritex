...
if __name__ == "__main__":
    ...
    file_handler = logging.FileHandler('verify_p5.log', 'w+')
    ...
    properties  = vnnlib_to_properties('../nets/prop_5.vnnlib', num_inputs=5, num_outputs=5)
    ...
    for n, prop in enumerate(properties):
        ...
        logging.info('')
        logging.info(f'Network {i} {j} on property 5')
