...
This section aims to reproduce results in the CAV'22 tool paper, inculding Figure 2&3&4 and Table 2&3. Results are stored in 'veritex/cav22_artifact/results'. ![#f03c15](https://via.placeholder.com/15/f03c15/000000?text=+) `#f03c15`
