...
savename = 'figure4(a)_original_reach_property_1_2_dims_0_1'
run([property1, property2], network_path, dims, savename)

network_path = '../examples/DRL/nets/logs/agent_lr1e-06_epochs50_alpha1.0_beta0.0/repaired_model.pt'
savename = 'figure4(b)_veritex_reach_property_1_2_dims_0_1'
run([property1, property2], network_path, dims, savename)

dims = (0,2)
network_path = '../examples/DRL/nets/unsafe_agent0.pt'
savename = 'figure4(c)_original_reach_property_1_2_dims_0_2'
run([property1, property2], network_path, dims, savename)

network_path = '../examples/DRL/nets/logs/agent_lr1e-06_epochs50_alpha1.0_beta0.0/repaired_model.pt'
savename = 'figure4(d)_veritex_reach_property_1_2_dims_0_2'
run([property1, property2], network_path, dims, savename)
