...
if __name__ == "__main__":
    ...
    ax.autoscale()
    ax.set_xlabel('$y_'+str(dim0)+'$', fontsize=18)
    ax.set_ylabel('$y_'+str(dim1)+'$', fontsize=18)
