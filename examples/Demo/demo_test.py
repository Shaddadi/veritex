...
def reach_relu_network():
    ...
    dim0, dim1 = 0, 1
    plot_polytope2d(appr_vs[[dim0, dim1],:].T, ax, color='c', alpha=1.0, edgecolor='k', linewidth=0.0, zorder=2)
